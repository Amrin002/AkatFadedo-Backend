                                    ...
                                    @foreach ($berita as $row)
                                        <tr>
                                            ...
                                            <div class="modal fade" id="deleteBeritaModal{{ $row->id }}" tabindex="-1"
                                                aria-labelledby="deleteBeritaModalLabel{{ $row->id }}" aria-hidden="true">
                                            ...
                                            <!-- Modal Edit Berita -->
                                            <div class="modal fade" id="editBeritaModal{{ $row->id }}" tabindex="-1"
                                                role="dialog" aria-labelledby="editBeritaModalTitle{{ $row->id }}" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('berita.update', $row->id) }}" method="POST"
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="konten">Konten</label>
                                                                    <textarea class="form-control" id="konten{{ $row->id }}"
                                                                        name="konten" rows="3" required>{{ $row->konten }}</textarea>
                                                                </div>
