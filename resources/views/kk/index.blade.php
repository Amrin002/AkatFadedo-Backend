                                ...
                                <tbody>
                                    @foreach ($kk as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <button type="button" class="btn btn-warning btn-sm"
                                                        data-toggle="modal" data-target="#editModal{{ $row->no_kk }}">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </button>
                                                    <form action="{{ route('kk.destroy', $row->no_kk) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                            ...
                                            <div class="modal fade" id="deleteModal{{ $row->no_kk }}" tabindex="-1"
                                                aria-labelledby="deleteModalLabel{{ $row->no_kk }}" aria-hidden="true">
                                                        ...
                                                        <form action="{{ route('kk.update', $row->no_kk) }}"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="dusun"
                                                                    value="{{ $row->dusun }}" required>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="rt">RT</label>
                                                                <input type="text" class="form-control" name="rt"
                                                                    value="{{ $row->rt }}" required>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="rw">RW</label>
                                                                <input type="text" class="form-control" name="rw"
                                                                    value="{{ $row->rw }}" required>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="desa">Desa</label>
                                                                <input type="text" class="form-control" name="desa"
                                                                    value="{{ $row->desa }}" required>
                                                            </div>
