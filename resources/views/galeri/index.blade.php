																																								...
																																								<div class="modal-body">
																																												<form action="{{ route("galeri.store") }}" method="POST"
																																																...
																																																<div class="form-group">
																																																				...
																																																				<div class="form-check">
																																																								<input class="form-check-input" type="radio"
																																																												name="kegiatan_option" id="pilihExisting" value="existing"
																																																												checked>
																																																				...
																																																				<div class="form-check">
																																																								<input class="form-check-input" type="radio"
																																																												name="kegiatan_option" id="buatBaru" value="new">
																																																...
																																																<div class="form-group" id="existingKegiatanGroup">
																																																				...
																																																				<select class="form-control" id="kegiatan_desa_id"
																																																								name="kegiatan_desa_id">
																																																								<option value="">-- Pilih Kegiatan --</option>
																																																								@foreach ($kegiatanList as $kegiatan)
																																																												<option value="{{ $kegiatan->id }}"
																																																																{{ old("kegiatan_desa_id") == $kegiatan->id ? "selected" : "" }}>
																																																																{{ $kegiatan->judul }}
																																																												</option>
																																																								@endforeach
																																																				</select>
																																																...
																																																<div id="newKegiatanGroup" style="display: none;">
																																																				<div class="card bg-light mb-3">
																																																								<div class="card-body">
																																																												...
																																																												<div class="form-group">
																																																																<label for="judul_kegiatan_baru">Judul Kegiatan Baru</label>
																																																																<input type="text" class="form-control"
																																																																				id="judul_kegiatan_baru" name="judul_kegiatan_baru"
																																																																				placeholder="Contoh: Perayaan 17 Agustus 2025">
																																																												</div>
																																																												<div class="form-group">
																																																																<label for="deskripsi_kegiatan_baru">Deskripsi</label>
																																																																<textarea class="form-control" id="deskripsi_kegiatan_baru" name="deskripsi_kegiatan_baru" rows="3"
																																																																    placeholder="Deskripsi kegiatan (opsional)"></textarea>
																																																												</div>
																																																												<div class="form-group">
																																																																<label for="tanggal_kegiatan_baru">Tanggal Kegiatan</label>
																																																																<input type="date" class="form-control"
																																																																				id="tanggal_kegiatan_baru" name="tanggal_kegiatan_baru">
																																																												</div>
																																																								</div>
																																																				</div>
																																																</div>
																																				...
																																				<tbody>
																																								@forelse ($galeri as $row)
																																												<tr>
																																																...
																																																<td>
																																																				<img src="{{ asset("storage/" . $row->image) }}" alt="Foto Profil"
																																																								width="100" height="100" style="border-radius: 10%">
																																																</td>
																																																<td>
																																																								...
																																																								<div class="modal-content">
																																																												...
																																																												<div class="modal-body">
																																																																<form action="{{ route("galeri.update", $row->id) }}"
																																																																				...
																																																																				@method("PUT")
																																																																				<div class="form-group">
																																																																								<label for="nama_edit">Nama Kegiatan</label>
																																																																								<input type="text" class="form-control"
																																																																												id="nama_edit" name="nama_kegiatan"
																																																																												value="{{ $row->nama_kegiatan }}" required>
																																																																				</div>

																																																																				<div class="form-group">
																																																																								<label for="kegiatan_desa_id_edit">Label
																																																																												Kegiatan</label>
																																																																								<select class="form-control"
																																																																												id="kegiatan_desa_id_edit"
																																																																												name="kegiatan_desa_id" required>
																																																																												<option value="">-- Pilih Kegiatan --
																																																																												</option>
																																																																												@foreach ($kegiatanList as $kegiatan)
																																																																																<option value="{{ $kegiatan->id }}"
																																																																																				{{ $row->kegiatan_desa_id == $kegiatan->id ? "selected" : "" }}>
																																																																																				{{ $kegiatan->judul }}
																																																																																</option>
																																																																												@endforeach
																																																																								</select>
																																																																				...
																																																																				<div class="form-group">
																																																																								<label for="image_edit">Foto Kegiatan</label>
																																																																								<input type="file"
																																																																												class="form-control galeri-image"
																																																																												id="image_edit" name="image"
