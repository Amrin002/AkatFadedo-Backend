                                                    ...
                                                    <div class="card bg-light mb-3">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control" id="tanggal_kegiatan_baru" name="tanggal_kegiatan_baru">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <tbody>
                                        @forelse ($galeri as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset("storage/" . $row->image) }}" alt="Foto Profil" width="100" height="100" style="border-radius: 10%">
                                                </td>
                                                <td>
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ route("galeri.update", $row->id) }}" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" id="nama_edit" name="nama_kegiatan" value="{{ $row->nama_kegiatan }}" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label for="kegiatan_desa_id_edit">Label Kegiatan</label>
                                                                        <select class="form-control" id="kegiatan_desa_id_edit" name="kegiatan_desa_id" required>
                                                                            <option value="">-- Pilih Kegiatan --</option>
                                                                            @foreach ($kegiatanList as $kegiatan)
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="file" class="form-control galeri-image" id="image_edit" name="image" accept="image/png, image/jpeg">
                                                                        @if ($row->image)
