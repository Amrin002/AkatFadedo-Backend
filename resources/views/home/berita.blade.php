    ...
    <main class="container mt-5 mb-5">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <img src="{{ asset('storage/' . $berita->gambar) }}" class="img-fluid rounded mb-4"
                    style="max-height: 500px; object-fit: cover; width: 100%;" alt="{{ $berita->judul }}">
                ...
                @foreach ($berita_terbaru as $item)
                    <a href="{{ route('home.berita', $item->slug) }}" class="text-dark text-decoration-none">
                        <div class="d-flex mb-3">
                            <img src="{{ asset('storage/' . $item->gambar) }}" alt="" class="me-2"
