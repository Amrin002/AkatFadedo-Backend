...
@section('content')
    <div class="main-wrapper">
        <div class="content-area">
            <main class="container py-5 struktur-container" style="margin-top: 70px;">
                <h2 class="mb-5 text-center fw-bolder text-dark" style="font-size:2.2rem;">Struktur Organisasi Desa Akat
                    Fadedo</h2>
                            ...
                            <div class="card team-card shadow-sm border-0 w-100 text-center">
                                ...
                                <div class="card-body">
                                    <img src="{{ asset('storage/' . $anggota->image) }}"
                                        class="img-fluid rounded-circle shadow-sm mb-3" alt="{{ $anggota->nama }}"
