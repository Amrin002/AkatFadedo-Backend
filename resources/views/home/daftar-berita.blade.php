...
@section('content')
    <div class="main-wrapper">
        <div class="content-area">
            <main class="container py-5 berita-container" style="margin-top: 70px;"> {{-- ✅ Jeda dari navbar --}}
                {{-- Judul Halaman --}}
                ...
                <div class="row mb-5">
                    <div class="col-md-6">
                        <form action="{{ route('home.daftar-berita') }}" method="GET" class="d-flex">
                            <select name="kategori" id="kategori" class="form-select me-2 shadow-sm rounded-pill"
                            ...
                            <div class="card berita-card h-100 border-0 shadow-sm rounded-3 overflow-hidden">
                                ...
                                <a href="{{ route('berita.show', $item->slug) }}" class="berita-img-link">
                                    <img src="{{ asset('storage/' . $item->gambar) }}" alt="{{ $item->judul }}"
                                        class="card-img-top berita-img" style="height: 220px; object-fit: cover;">
                                </a>
