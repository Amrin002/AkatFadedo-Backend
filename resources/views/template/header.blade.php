                                    ...
                                    <li>
                                        <a href="icon-menu.html">
                                            <span class="sub-item">Icon Menu</span>
																												...
																												<!-- Bagian Landing Page di Sidebar -->
																												<li class="nav-item">
																																...
																																<div class="collapse {{ request()->is("fasilitas*") || request()->is("struktur*") || request()->is("galeri*") || request()->is("kegiatan*") ? "show" : "" }}"
																																				id="charts">
																																				<ul class="nav nav-collapse">
																																								...
																																								<li
																																												class="nav-item {{ request()->is("galeri*") || request()->is("kegiatan*") ? "active" : "" }}">
																																												<a href="{{ url("/galeri") }}">
																								...
																								<div class="logo-header" data-background-color="dark">
																												<a href="{{ route("home") }}" class="logo">
																																<img src={{ asset("admin/assets/img/Logo2.png") }} alt="navbar brand" <img
																																				src={{ asset("admin/assets/img/Logo2.png") }} alt="navbar brand"
                                                ...
                                                class="fa fa-angle-right"></i>
																																...
																																<li class="nav-item topbar-icon dropdown hidden-caret">
																																				...
																																				<ul class="dropdown-menu notif-box animated fadeIn"
																																																...
																																																<div class="notif-center">
																																																				@forelse($notifications as $notification)
																																																								<a href="{{ route("notifications.mark-read-link", $notification->id) }}"
																																																												...
																																																												<div class="notif-content">
																																																																<span
																																																																				class="block">{{ $notification->message }}</span>
																																																																<span
																																								...
																																								<li>
																																												<a class="see-all"
																																																href="{{ route("notifications.mark-all-read-link") }}">
