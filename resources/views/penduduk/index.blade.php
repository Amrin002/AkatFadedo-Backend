                                        ...
                                        <form action="{{ route('penduduk.store') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="no_kk"
                                                    ...
                                                    id="no_kk" placeholder="No KK" value="{{ old('no_kk') }}" required
                                                    maxlength="16">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nik"
                                                    ...
                                                    id="nik" placeholder="No NIK" value="{{ old('nik') }}" required
                                                    maxlength="16">
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('nik') }}
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_ibu"
                                                    ...
                                                    id="nama_ibu" placeholder="Nama Ibu" value="{{ old('nama_ibu') }}"
                                                    required>
                                                <div class="invalid-feedback">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="agama"
                                                                    name="agama" value="{{ $row->agama }}" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="pendidikan">Pendidikan</label>
                                                                <input type="text" class="form-control"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="nama_ayah"
                                                                    name="nama_ayah" value="{{ $row->nama_ayah }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="nama_ibu">Nama Ibu</label>
                                                                <input type="text" class="form-control" id="nama_ibu"
                                                                    name="nama_ibu" value="{{ $row->nama_ibu }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="email">Email</label>
