...
class LandingPageController extends Controller
{
    public function index()
    {
        ...
        return view('home.index', compact('jumlahPenduduk', 'fasilitas', 'strukturDesa', 'galeri', 'berita', 'title', 'jumlahKk', 'jumlahLakiLaki', 'jumlahPerempuan', 'apbdes', 'umkm', 'kategoriData'));
    }
